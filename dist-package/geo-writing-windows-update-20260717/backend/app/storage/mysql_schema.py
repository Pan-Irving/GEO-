...
writing_skill_versions = Table(
    ...
    Column("created_at", String(64), nullable=False),
    Column("updated_at", String(64), nullable=False),
    Index("idx_skill_versions_status_created", "status", "created_at"),
)

writing_skill_slots = Table(
    "writing_skill_slots",
    metadata,
    Column("version_id", String(64), ForeignKey("writing_skill_versions.id", ondelete="CASCADE"), primary_key=True),
    Column("article_type", String(120), primary_key=True),
...
writing_skill_candidates = Table(
    ...
    Column("sha256", String(128), nullable=False),
    Column("uploaded_at", String(64), nullable=False),
    Index("idx_skill_candidates_slot", "article_type", "stage", "uploaded_at"),
)

writing_skill_active_slots = Table(
