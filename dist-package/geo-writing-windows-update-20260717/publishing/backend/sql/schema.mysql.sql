...
CREATE TABLE IF NOT EXISTS article_snapshots (
  ...
  KEY idx_article_project_active_sort (project_id, active, intent_group, article_type),
  KEY idx_article_intent_group_type (intent_group, article_type),
...
CREATE TABLE IF NOT EXISTS assignments (
  ...
  user_id VARCHAR(64) NOT NULL,
  project_id VARCHAR(191) NOT NULL,
  intent_group_ids_json TEXT NOT NULL,
  intent_groups_json TEXT NOT NULL,
